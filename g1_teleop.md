...
## 整身控制任务数据采集
```
    1. 测试新的teleop with 宇树运控 [无手]

        # 1号机PC2无响应，需要直连realsense，需要检查realsense camera serial number

            (base) junweil@precognition-laptop6:~$ rs-enumerate-devices
                 18/10 10:41:04,426 ERROR [126346063124352] (context.cpp:40) No valid configuration file found at : /home/junweil/.realsense-config.json loading defaults
                Device info:
        ...
        # 1.2 测试
            (tv) junweil@precognition-laptop6:~/projects/xr_teleoperate/teleop$ python teleop_hand_and_arm.py --xr-mode=controller  --arm=G1_29 --ee=dex3 --record --network_interface enp131s0 --motion --use_waist --task_name open_washer_door --task_dir ../data/open_washer_door --no_hand --image_server_ip 127.0.0.1
                     ...
                     13:02:30:104715 INFO     Average Frame Latency (last 500      image_client_timesync.py:209
                        ...
                        13:02:50:124960 INFO     Average Frame Latency (last 500      image_client_timesync.py:209
                                                 frames): 1.21 ms
                        13:02:58:248517 INFO     [MainLoop] (last 10.0s): 59.26 Hz              helper_utils.py:77
                        13:02:58:248604 INFO       └─ [solve_ik] Avg: 3.94 ms (593 calls)       helper_utils.py:83
