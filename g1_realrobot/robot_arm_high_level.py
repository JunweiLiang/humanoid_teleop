...
class G1_29_ArmController:
    ...
    def ctrl_right_arm_go_home(self):
        ...
        print("[G1_29_ArmController] ctrl_right_arm_go_home start...")
        with self.ctrl_lock:
            self.q_target = np.zeros(7)
...
if __name__ == "__main__":
    ...
    if user_input.lower() == 's':
        ...
        while True:
            ...
            # 关节目标，以及根据关节目标、关节速度得到的 扭矩输出
            """
            对于电机的底层控制算法，唯一需要的控制目标就是输出力矩 (旋转力)。对于机器人，我们通常需要给关节设定位置、速度和力矩，就需要对关节电机进行混合控制。
