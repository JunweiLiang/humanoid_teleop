...
parser.add_argument("--show_states", action="store_true", help="show hand states instead of actions")
...
def show_current_q(vis_model, step_data, leg_state_qpos, hand_type="inspire1"):
...
if __name__ == "__main__":
    ...
    vis_model = G1_29_Vis_Episode(urdf=args.urdf, hand_type=args.hand_type)
                ...
                if char == 's':
                    ...
                    if paused and not plus_pressed_handled:
                        ...
                        if args.show_states:
                            ...
                            step_data = episode["data"][current_step]["actions"]
                        # 兼容bug
                        leg_key = "leg" if "leg" in episode["data"][current_step]["states"]["leg"] else "qpos"
                        leg_state_qpos = episode["data"][current_step]["states"]["leg"][leg_key] # 12 num
                        show_current_q(
                            vis_model, step_data, leg_state_qpos,
